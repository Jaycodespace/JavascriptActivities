...
let computerParts1 = [["GTX 4000", "Intel i9", "Ram"], "Fan"];
console.log(checkIfPartExists(computerParts1, "FAM"));
let computerParts2 = [["GTX 4000", "Intel i9", "Ram"], "Fan"];
console.log(checkIfPartExists(computerParts2, "Fan"));

const cart1 = ["Mouse", "Keyboard"];
const cart2 = ["Monitor", "CPU"];
console.log(combineCart(cart1, cart2));

const sampleArray = ["Hello", "World"];
console.log(arrayToString(sampleArray));

console.log(joinArrays(sampleArray, " - "));